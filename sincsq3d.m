function wtrans=sincsq3d(ifl,klocs_d1,klocs_d2,klocs_d3,q,rsamp)
...
wtrans=(1/64)*finufft3d3(allxx,allyy,allzz,h_at_xxyyzz.*allww,1,1e-15,klocs_d1,klocs_d2,klocs_d3);
wtrans=real(wtrans);
